    ...
    renderSubText(){
        if(this.state.active === false){
            if(this.props.session.jsonArray.length === 1){
                return <View><Text style={styles.sessionSmallText}>{this.props.session.jsonArray[0].workoutname}</Text></View>
            } else  if(this.props.session.jsonArray.length === 2){
                return <View><Text style={styles.sessionSmallText}>{this.props.session.jsonArray[0].workoutname}, {this.props.session.jsonArray[1].workoutname} </Text></View>
            } else {
                return <View><Text style={styles.sessionSmallText}>{this.props.session.jsonArray[0].workoutname}, {this.props.session.jsonArray[1].workoutname}, {this.props.session.jsonArray[2].workoutname}... </Text></View>
            }
        } 
    }
    showEachSession(){
